...
export default function TopBanner() {
  return (
    <div className="bg-white border-b border-gray-200 hidden md:block relative z-[60] overflow-visible">
      <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between text-sm">
        {/* Left: Social Icons */}
        <div className="flex items-center gap-3">
          <a
            href="https://www.facebook.com/AC878FM"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-600 hover:text-[#da2d2d] transition-colors"
            title="Facebook"
          >
          ...
          <a
            href="https://www.instagram.com/ac878media/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-600 hover:text-[#da2d2d] transition-colors"
            title="Instagram"
